            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" name="name" value="{{ old('bane') }}" class="form-control">
                        @if($errors->has('name'))
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-md-6 row">
                            <label for="protocol-http">
                                <input type="radio" id="protocol-http" name="protocol" value="http">
                                HTTP
                            </label>
                        </div>
                        <div class="col-md-6 row">
                            <label for="protocol-https">
                                <input type="radio" id="protocol-https" name="protocol" value="https">
                                HTTPS
                            </label>
                        </div>
