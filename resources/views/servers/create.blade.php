            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" name="host_ip" value="{{ old('host_ip') }}" class="form-control">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="ssh_user" class="form-control" value="{{ old('ssh_user','root') }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="ssh_port" class="form-control" value="{{ old('ssh_port','22') }}">
